import{j as e}from"./jsx-runtime-f961835c.js";import{C as l}from"./Checkbox-5bb7d141.js";import{T as G}from"./_TogglerGroupField-a5a150dc.js";import{T as D}from"./_TogglerInput-66f6c90c.js";import{R as B,a as g}from"./RowBlockColumn-9fede1a2.js";import"./index-f80c8c95.js";import"./getSVGtext-a8bc7f1c.js";import"./FormField-40abbd78.js";import"./i18n-d547729d.js";import"./env-5a2a565d.js";import"./_useMobileMenuToggling-7bb485b9.js";import"./browserSide-4379edd8.js";import"./_Link-b7c9c4c9.js";const h=a=>e.jsx(G,{...a,bem:"CheckboxGroup",modifier:a.layout,Toggler:l});try{h.displayName="CheckboxGroup",h.__docgenInfo={description:"",displayName:"CheckboxGroup",props:{className:{defaultValue:null,description:'Container className - alongside "FormField"',name:"className",required:!1,type:{name:"string"}},ssr:{defaultValue:null,description:`Indicates whether server-side rendering is supported or not.
...
All falsy values are neatly skipped.`,name:"modifier",required:!1,type:{name:"ClassNameModifiers"}},label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string | Element"}},hideLabel:{defaultValue:null,description:"",name:"hideLabel",required:!1,type:{name:"boolean"}},invalid:{defaultValue:null,description:"",name:"invalid",required:!1,type:{name:"boolean"}},errorMessage:{defaultValue:null,description:"",name:"errorMessage",required:!1,type:{name:"string | Element"}},inputProps:{defaultValue:null,description:"",name:"inputProps",required:!1,type:{name:"DetailedHTMLProps<InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>"}},Wrapper:{defaultValue:null,description:"",name:"Wrapper",required:!1,type:{name:"enum",value:[{value:'"div"'},{value:'"li"'}]}}}}}catch{}const y=a=>e.jsx(G,{...a,bem:"RadioGroup",modifier:a.layout,isRadio:!0,Toggler:r});try{y.displayName="RadioGroup",y.__docgenInfo={description:"",displayName:"RadioGroup",props:{className:{defaultValue:null,description:'Container className - alongside "FormField"',name:"className",required:!1,type:{name:"string"}},ssr:{defaultValue:null,description:`Indicates whether server-side rendering is supported or not.
...
//# sourceMappingURL=CheckboxAndRadio.stories-df8176d8.js.map

import{j as a}from"./getSVGtext-33d0ab58.js";import{T as k}from"./_TogglerInput-a4756d98.js";import{T}from"./_TogglerGroupField-42173bc3.js";import"./index-f80c8c95.js";import"./i18n-d547729d.js";import"./_useMobileMenuToggling-af42c346.js";import"./FormField-62273174.js";import"./env-5a2a565d.js";import"./browserSide-4379edd8.js";import"./_Link-b7c9c4c9.js";const i=e=>a.jsx(k,{bem:"CheckboxButton",...e,type:"checkbox",innerWrap:!0});try{i.displayName="CheckboxButton",i.__docgenInfo={description:"",displayName:"CheckboxButton",props:{modifier:{defaultValue:null,description:`List of CSS BEM --modifier's to add to the component's main wrapper.

All falsy values are neatly skipped.`,name:"modifier",required:!1,type:{name:"ClassNameModifiers"}},label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string | Element"}},invalid:{defaultValue:null,description:"",name:"invalid",required:!1,type:{name:"boolean"}},errorMessage:{defaultValue:null,description:"",name:"errorMessage",required:!1,type:{name:"string | Element"}},reqText:{defaultValue:null,description:`Hidden label prefix text to indicate that the field is required.

If your field is required but should not say so in its label
then set this prop to \`false\`

Default: \`"Þarf að haka í" / "Must be checked" / "Należy sprawdzić"\`.`,name:"reqText",required:!1,type:{name:"string | false"}},wrapperProps:{defaultValue:null,description:`Custom HTML attributes for the component's wrapper element.
...
//# sourceMappingURL=CheckboxAndRadioButtons.stories-b6b7c136.js.map

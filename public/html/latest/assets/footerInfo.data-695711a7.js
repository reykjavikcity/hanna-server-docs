import{j as e}from"./jsx-runtime-f961835c.js";import{m as r}from"./getSVGtext-6e71cb30.js";const i=s=>{const{boxes:l,wrapperProps:t}=s;return e.jsx("div",{...t,className:r("FooterInfo",null,(t||{}).className),children:l.map((a,n)=>e.jsxs("div",{className:r("FooterInfo__group",[a.main&&"main",a.modifier]),children:[e.jsx("h3",{className:"FooterInfo__grouptitle",children:a.title}),a.content?e.jsx("div",{className:r("FooterInfo__groupcontent",a.modifier),children:a.content}):e.jsx("div",{className:r("FooterInfo__groupcontent",a.modifier),dangerouslySetInnerHTML:{__html:a.html}})]},n))})};try{i.displayName="FooterInfo",i.__docgenInfo={description:"",displayName:"FooterInfo",props:{boxes:{defaultValue:null,description:"",name:"boxes",required:!0,type:{name:"FooterInfoBoxes"}},wrapperProps:{defaultValue:null,description:`Custom HTML attributes for the component's wrapper element.
...
component. User discretion is advised.`,name:"wrapperProps",required:!1,type:{name:"HTMLProps<null, never>"}}}}}catch{}const d={boxes:[{title:"Opnunartímar",main:!0,html:`
        <h4>Þjónustuver</h4>
        <p>
      ...
      `}]};export{i as F,d as f};
//# sourceMappingURL=footerInfo.data-695711a7.js.map

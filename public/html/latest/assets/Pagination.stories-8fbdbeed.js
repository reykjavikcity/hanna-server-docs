...
component. User discretion is advised.`,name:"wrapperProps",required:!1,type:{name:'HTMLProps<null, "aria-label">'}}}}}catch{}const N=["link","button","submit"],w=["1_25","9_25","25_25","1_5"],O={title:"Pagination",parameters:{viewport:{defaultViewport:"responsive"}}},C=t=>{const{type:e,state:a}=t,[r,n]=a.split("_").map(Number),o=e==="link"?{href:"?page=${page}"}:{onChange:()=>{},submit:e==="submit"},i=[e,r,n].join("-");return p.jsx(g,{current:r,pageCount:n,...o},i)},m={render:t=>p.jsx(C,{...t}),argTypes:{type:{name:"Button type",options:N,control:{type:"inline-radio",labels:{link:"Links",button:"Buttons",submit:"Submit buttons"}}},state:{name:"Status",options:w,control:{type:"radio",labels:{"1_25":"First page","9_25":"Page near the middie","25_25":"Last page","1_5":"Short list"}}}},args:{type:"link",state:"1_25"}};var b,f,y;m.parameters={...m.parameters,docs:{...(b=m.parameters)==null?void 0:b.docs,source:{originalSource:`{
...
}`,...(y=(f=m.parameters)==null?void 0:f.docs)==null?void 0:y.source}}};const z=["_Pagination"];export{m as _Pagination,z as __namedExportsOrder,O as default};
//# sourceMappingURL=Pagination.stories-8fbdbeed.js.map

import{j as r}from"./jsx-runtime-f961835c.js";import{m as e}from"./classUtils-ef6e60eb.js";const l=i=>{const{boxes:s}=i;return r.jsx("div",{className:"FooterInfo",children:s.map((a,t)=>r.jsxs("div",{className:e("FooterInfo__group",[a.main&&"main",a.modifier]),children:[r.jsx("h3",{className:"FooterInfo__grouptitle",children:a.title}),a.content?r.jsx("div",{className:e("FooterInfo__groupcontent",a.modifier),children:a.content}):r.jsx("div",{className:e("FooterInfo__groupcontent",a.modifier),dangerouslySetInnerHTML:{__html:a.html}})]},t))})};try{l.displayName="FooterInfo",l.__docgenInfo={description:"",displayName:"FooterInfo",props:{boxes:{defaultValue:null,description:"",name:"boxes",required:!0,type:{name:"FooterInfoBoxes"}}}}}catch{}const f={boxes:[{title:"Opnunartímar",main:!0,html:`
        <h4>Þjónustuver</h4>
        <p>
      ...
      `}]};export{l as F,f};
//# sourceMappingURL=footerInfo.data-9a1d4325.js.map

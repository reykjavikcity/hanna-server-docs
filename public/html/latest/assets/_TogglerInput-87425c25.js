import{j as e}from"./jsx-runtime-f961835c.js";import{m as N}from"./classUtils-ef6e60eb.js";import{h as T}from"./index-603b371f.js";const m=l=>{const{bem:r,modifier:c,className:f,label:y,invalid:b,errorMessage:a,Wrapper:h="div",required:_,reqText:i,type:v,id:g,innerWrap:q,wrapperProps:s,inputProps:o,...n}=l,t=T.useDomid(g),d=a&&"error"+t,x=_&&i!==!1&&e.jsx("abbr",{className:r+"__label__reqstar",title:(i||"Þarf að haka í")+": ",children:"*"}),p=n.readOnly||(o||{}).readOnly,u=e.jsxs(e.Fragment,{children:[" ",x," ",y," "]});return e.jsxs(h,{...s,className:N(r,c,f||(s||{}).className),children:[e.jsx("input",{className:r+"__input",type:v,id:t,"aria-invalid":b||!!a||void 0,"aria-describedby":d,...n,...o,...p&&{disabled:!0}})," ",e.jsxs("label",{className:r+"__label",htmlFor:t,children:[q?e.jsx("span",{className:r+"__label__wrap",children:u}):u,p&&e.jsx("input",{type:"hidden",name:n.name,value:n.value})]}),a&&e.jsx("div",{className:r+"__error",id:d,children:a})]})};try{m.displayName="TogglerInput",m.__docgenInfo={description:"",displayName:"TogglerInput",props:{label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string | Element"}},invalid:{defaultValue:null,description:"",name:"invalid",required:!1,type:{name:"boolean"}},reqText:{defaultValue:null,description:`Hidden label prefix text to indicate that the field is required.
...
//# sourceMappingURL=_TogglerInput-87425c25.js.map

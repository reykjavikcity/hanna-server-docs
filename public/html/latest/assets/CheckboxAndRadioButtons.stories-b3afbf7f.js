import{j as a}from"./jsx-runtime-f961835c.js";import{T as k}from"./_TogglerInput-01a97f3b.js";import{T as G}from"./_TogglerGroupField-8eae2529.js";import"./index-f80c8c95.js";import"./classUtils-ef6e60eb.js";import"./getScrollbarWidth-70c1e033.js";import"./getSVGtext-8f35f9ab.js";import"./FormField-d640972f.js";import"./env-5a2a565d.js";import"./browserSide-4379edd8.js";import"./_Link-b7c9c4c9.js";const o=e=>a.jsx(k,{bem:"CheckboxButton",...e,type:"checkbox",innerWrap:!0});try{o.displayName="CheckboxButton",o.__docgenInfo={description:"",displayName:"CheckboxButton",props:{label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string | Element"}},invalid:{defaultValue:null,description:"",name:"invalid",required:!1,type:{name:"boolean"}},reqText:{defaultValue:null,description:`Hidden label prefix text to indicate that the field is required.
...
Default: \`"Þarf að fylla út"\``,name:"reqText",required:!1,type:{name:"string | false"}},wrapperRef:{defaultValue:null,description:"@deprecated Use `*Props.wrapperProps.ref` instead (Will be removed in v0.11)\n\nRef object pointing to the outermost `.FormField` element",name:"wrapperRef",required:!1,type:{name:"RefObject<HTMLElement>"}},LabelTag:{defaultValue:null,description:"",name:"LabelTag",required:!1,type:{name:"enum",value:[{value:'"h3"'},{value:'"h4"'},{value:'"h5"'}]}},options:{defaultValue:null,description:"",name:"options",required:!0,type:{name:'string[] | TogglerGroupOptions<"default", {}>'}},name:{defaultValue:null,description:"",name:"name",required:!1,type:{name:"string"}},disabled:{defaultValue:null,description:"",name:"disabled",required:!1,type:{name:"boolean | readonly number[]"}},inputProps:{defaultValue:null,description:"",name:"inputProps",required:!1,type:{name:"RestrictedInputProps"}},onSelected:{defaultValue:null,description:"",name:"onSelected",required:!1,type:{name:'((payload: { value: string; checked: boolean; option: TogglerGroupOption<"default", {}>; selectedValues: string[]; }) => void)'}},"aria-describedby":{defaultValue:null,description:"",name:"aria-describedby",required:!1,type:{name:"string"}},"aria-invalid":{defaultValue:null,description:"",name:"aria-invalid",required:!1,type:{name:'boolean | "true" | "false"'}},"aria-labelledby":{defaultValue:null,description:"",name:"aria-labelledby",required:!1,type:{name:"string"}},value:{defaultValue:null,description:"",name:"value",required:!1,type:{name:"string"}},defaultValue:{defaultValue:null,description:"",name:"defaultValue",required:!1,type:{name:"string"}},stacked:{defaultValue:null,description:"Display the buttons in a single column",name:"stacked",required:!1,type:{name:"boolean"}},columns:{defaultValue:null,description:"@deprecated (Will be removed in v0.11)",name:"columns",required:!1,type:{name:"enum",value:[{value:'"2col"'},{value:'"3col"'}]}},layout:{defaultValue:null,description:"@deprecated (Will be removed in v0.11)",name:"layout",required:!1,type:{name:"enum",value:[{value:'"slim"'}]}}}}}catch{}const W={title:"Forms/Checkbox & Radio Buttons",argTypes:{required:{name:"Required"},invalid:{name:"Invalid"},errorMessage:{name:"Error message"},disabled:{name:"Disabled"}},args:{subText:!0,required:!1,invalid:!1,errorMessage:!1},parameters:{controls:{hideNoControlsWarning:!0},viewport:{defaultViewport:"responsive"}}},s={name:"CheckboxButton",render:e=>{const{subText:n,required:u,invalid:d,errorMessage:t,disabled:p}=e,r=t?"You must accept this nice offer.":void 0,m="Add me to your professional network on LinkedIn",b=n?a.jsxs(a.Fragment,{children:[m," ",a.jsx("small",{children:"(Just kidding)"})]}):m;return a.jsx(o,{label:b,required:u,invalid:d,disabled:p,errorMessage:r})},argTypes:{subText:{name:"Sub-text (small print)"}},args:{subText:!1,disabled:!1}},P=[{value:"Jón",label:a.jsxs(a.Fragment,{children:["Jón Jónsson ",a.jsx("small",{children:"Fæddur 1991"})]})},{value:"Anna",label:a.jsx(a.Fragment,{children:"Anna Önnudóttir"})},{value:"Gunnar",label:a.jsxs(a.Fragment,{children:["Gunnar Gunnarilíus Gunnarsson ",a.jsx("small",{children:"Fæddur 1995"})]})},{value:"Guðrún",label:a.jsxs(a.Fragment,{children:["Guðrún Guðrúnardóttir ",a.jsx("small",{children:"Fædd 1997"})]})},{value:"Pétur",label:a.jsx(a.Fragment,{children:"Pétur Pétursson"})}],M=P.map((e,n)=>({...e,disabled:n>=2})),w=e=>{const{required:n,invalid:u,errorMessage:d,disabled:t}=e,p=d?"You must accept this nice offer.":void 0,r=t!=="none"?t:"";return{invalid:u,_errorMessage:p,options:r==="some"?M:P,required:n,_disabled:r==="some"?!1:!!r}},R=["none","some","all"],l={render:e=>a.jsx(c,{label:"Pick your fruits",name:"fruits",value:["Anna","Guðrún"],...w(e)}),argTypes:{stacked:{name:"Stacked (1 col)"},disabled:{name:"Disabled",options:R,control:{type:"inline-radio",labels:{none:"None",some:"Some",all:"All"}}}},args:{stacked:!1,disabled:"none"}},i={...l,render:e=>a.jsx(f,{label:"Pick your fruit",name:"fruit",value:"Anna",...w(e)})};var y,g,h;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`{
  name: 'CheckboxButton',
  render: args => {
    const {
      subText,
...
}`,...(_=(T=i.parameters)==null?void 0:T.docs)==null?void 0:_.source}}};const D=["_CheckboxButton","_CheckboxButtonsGroup","_RadioButtonsGroup"];export{s as _CheckboxButton,l as _CheckboxButtonsGroup,i as _RadioButtonsGroup,D as __namedExportsOrder,W as default};
//# sourceMappingURL=CheckboxAndRadioButtons.stories-b3afbf7f.js.map

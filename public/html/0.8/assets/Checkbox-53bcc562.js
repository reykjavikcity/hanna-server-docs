import{j as t}from"./getSVGtext-33d0ab58.js";import{T as r}from"./_TogglerInput-a4756d98.js";const a=e=>t.jsx(r,{bem:"Checkbox",...e,type:"checkbox"});try{a.displayName="Checkbox",a.__docgenInfo={description:"",displayName:"Checkbox",props:{label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string | Element"}},invalid:{defaultValue:null,description:"",name:"invalid",required:!1,type:{name:"boolean"}},reqText:{defaultValue:null,description:`Hidden label prefix text to indicate that the field is required.
...
//# sourceMappingURL=Checkbox-53bcc562.js.map

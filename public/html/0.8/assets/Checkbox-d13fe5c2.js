import{j as t}from"./jsx-runtime-f961835c.js";import{T as r}from"./_TogglerInput-f392bf1e.js";const a=e=>t.jsx(r,{bem:"Checkbox",...e,type:"checkbox"});try{a.displayName="Checkbox",a.__docgenInfo={description:"",displayName:"Checkbox",props:{label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string | Element"}},invalid:{defaultValue:null,description:"",name:"invalid",required:!1,type:{name:"boolean"}},reqText:{defaultValue:null,description:`Hidden label prefix text to indicate that the field is required.
...
//# sourceMappingURL=Checkbox-d13fe5c2.js.map

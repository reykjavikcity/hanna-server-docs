import{j as a}from"./jsx-runtime-f961835c.js";import{T as r}from"./_TogglerInput-331f3df2.js";const t=e=>a.jsx(r,{bem:"Checkbox",...e,type:"checkbox"});try{t.displayName="Checkbox",t.__docgenInfo={description:"",displayName:"Checkbox",props:{label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string | Element"}},invalid:{defaultValue:null,description:"",name:"invalid",required:!1,type:{name:"boolean"}},reqText:{defaultValue:null,description:`Hidden label prefix text to indicate that the field is required.
...
component. User discretion is advised.`,name:"wrapperProps",required:!1,type:{name:"HTMLProps<null, never>"}}}}}catch{}export{t as C};
//# sourceMappingURL=Checkbox-b2f212c8.js.map

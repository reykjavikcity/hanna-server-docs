...
component. User discretion is advised.`,name:"wrapperProps",required:!1,type:{name:"HTMLProps<null, never>"}},startSeen:{defaultValue:null,description:"@deprecated This prop does nothing nowadays (Will be removed in v0.11)",name:"startSeen",required:!1,type:{name:"boolean"}}}}}catch{}const C={title:"Carousel",parameters:{controls:{hideNoControlsWarning:!0},viewport:{defaultViewport:"responsive"}}},l=()=>e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        .Carousel p {
...
}`,...(a=(s=r.parameters)==null?void 0:s.docs)==null?void 0:a.source}}};const j=["_Carousel"];export{r as _Carousel,j as __namedExportsOrder,C as default};
//# sourceMappingURL=Carousel.stories-508db7ce.js.map

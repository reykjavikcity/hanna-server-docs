import{j as e}from"./jsx-runtime-f961835c.js";import{r as v}from"./index-f80c8c95.js";import{m as I}from"./classUtils-ef6e60eb.js";import{g as C}from"./i18n-f5d14da7.js";import{l as L}from"./_dummyData-e787b310.js";import"./range-dbab87d5.js";const R="rs_req_Init",h=`script#${R}`;let t=0;const T={en:{linkText:"Listen",linkLabel:"Listen to this page read outloud"},is:{linkText:"Hlusta",linkLabel:"Hlusta á þessa síðu lesna upphátt"},pl:{linkText:"Posłuchaj",linkLabel:"Posłuchaj tej strony odczytanej na głos"}},o=a=>{const{align:r,float:l,customerId:d="11315",lang:n="",voice:w=/^is(?:_is)?$/i.test(n)?"is_dora":"",readId:p="",readClass:b=p?"":"Layout__main",wrapperProps:c,texts:j}=a,{linkText:u,linkLabel:P}=C({lang:n.slice(0,2),texts:j},T);return v.useEffect(()=>{var m,g;if(!(t<0)){if(t===0){if(document.querySelector(h)){t=-1;return}const s=document.createElement("script");s.id=R,s.src=`https://cdn-eu.readspeaker.com/script/${d}/webReader/webReader.js?pids=wr`,s.onload=()=>{var f,y;return(y=(f=window.rspkr)==null?void 0:f.ui)==null?void 0:y.addClickEvents()},s.async=!0,document.head.appendChild(s)}return t++,(g=(m=window.rspkr)==null?void 0:m.ui)==null||g.addClickEvents(),()=>{var s;t--,t===0&&((s=document.querySelector(h))==null||s.remove())}}},[]),e.jsx("div",{...c,className:I("ReadSpeakerPlayer",[r==="right"&&`align-${r}`,l&&"float"],(c||{}).className),children:e.jsx("div",{id:"readspeaker_button1",className:"rs_skip rsbtn rs_preserve",children:e.jsxs("a",{rel:"nofollow",className:"rsbtn_play",accessKey:"L",title:P||u,href:`https://app-eu.readspeaker.com/cgi-bin/rsent?${new URLSearchParams({customerid:d,lang:n,voice:n&&w,autoLang:n?"false":"true",readclass:b,readid:p})}`,children:[e.jsx("span",{className:"rsbtn_left rsimg rspart",children:e.jsx("span",{className:"rsbtn_text",children:e.jsx("span",{children:u})})}),e.jsx("span",{className:"rsbtn_right rsimg rsplay rspart"})]})})})},k=()=>{var a,r;return(r=(a=window.rspkr)==null?void 0:a.ui)==null?void 0:r.destroyActivePlayer()};try{o.displayName="ReadSpeakerPlayer",o.__docgenInfo={description:"Embeds a ReadSpeaker player in the page",displayName:"ReadSpeakerPlayer",props:{customerId:{defaultValue:null,description:`Your ReadSpeaker account/customer ID
...
//# sourceMappingURL=ReadSpeakerPlayer.stories-87328ffe.js.map

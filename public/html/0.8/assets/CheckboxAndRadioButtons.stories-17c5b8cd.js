import{j as a}from"./jsx-runtime-f961835c.js";import{T}from"./_TogglerInput-73157548.js";import{T as k}from"./_TogglerGroupField-291f4cb5.js";import"./index-f80c8c95.js";import"./classUtils-ef6e60eb.js";import"./_useMobileMenuToggling-15a67498.js";import"./getSVGtext-8f35f9ab.js";import"./FormField-532841a0.js";import"./env-5a2a565d.js";import"./browserSide-4379edd8.js";import"./_Link-b7c9c4c9.js";const i=e=>a.jsx(T,{bem:"CheckboxButton",...e,type:"checkbox",innerWrap:!0});try{i.displayName="CheckboxButton",i.__docgenInfo={description:"",displayName:"CheckboxButton",props:{label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string | Element"}},invalid:{defaultValue:null,description:"",name:"invalid",required:!1,type:{name:"boolean"}},reqText:{defaultValue:null,description:`Hidden label prefix text to indicate that the field is required.
...
component. User discretion is advised.`,name:"wrapperProps",required:!1,type:{name:"HTMLProps<null, never>"}}}}}catch{}const p=e=>(e.layout&&console.warn("`CheckboxButtonsGroupProps.layout` is deprecated."),e.columns&&console.warn("`CheckboxButtonsGroupProps.columns` is deprecated."),a.jsx(k,{...e,bem:"CheckboxButtonsGroup",modifier:e.stacked&&"stacked",Toggler:i}));try{p.displayName="CheckboxButtonsGroup",p.__docgenInfo={description:"",displayName:"CheckboxButtonsGroup",props:{className:{defaultValue:null,description:'Container className - alongside "FormField"',name:"className",required:!1,type:{name:"string"}},wrapperProps:{defaultValue:null,description:`Custom HTML attributes for the component's wrapper element.
...
Default: \`"Þarf að fylla út"\``,name:"reqText",required:!1,type:{name:"string | false"}},wrapperRef:{defaultValue:null,description:"@deprecated Use `*Props.wrapperProps.ref` instead (Will be removed in v0.11)\n\nRef object pointing to the outermost `.FormField` element",name:"wrapperRef",required:!1,type:{name:"RefObject<HTMLElement>"}},LabelTag:{defaultValue:null,description:"",name:"LabelTag",required:!1,type:{name:"enum",value:[{value:'"h3"'},{value:'"h4"'},{value:'"h5"'}]}},options:{defaultValue:null,description:"",name:"options",required:!0,type:{name:'string[] | TogglerGroupOptions<"default", Record<string, never>>'}},name:{defaultValue:null,description:"",name:"name",required:!1,type:{name:"string"}},disabled:{defaultValue:null,description:"",name:"disabled",required:!1,type:{name:"boolean | readonly number[]"}},inputProps:{defaultValue:null,description:"",name:"inputProps",required:!1,type:{name:"RestrictedInputProps"}},onSelected:{defaultValue:null,description:"",name:"onSelected",required:!1,type:{name:'((payload: { value: string; checked: boolean; option: TogglerGroupOption<"default", Record<string, never>>; selectedValues: string[]; }) => void)'}},"aria-describedby":{defaultValue:null,description:"",name:"aria-describedby",required:!1,type:{name:"string"}},"aria-invalid":{defaultValue:null,description:"",name:"aria-invalid",required:!1,type:{name:'boolean | "true" | "false"'}},"aria-labelledby":{defaultValue:null,description:"",name:"aria-labelledby",required:!1,type:{name:"string"}},value:{defaultValue:null,description:"",name:"value",required:!1,type:{name:"string[]"}},defaultValue:{defaultValue:null,description:"",name:"defaultValue",required:!1,type:{name:"string[]"}},stacked:{defaultValue:null,description:"Display the buttons in a single column",name:"stacked",required:!1,type:{name:"boolean"}},columns:{defaultValue:null,description:"@deprecated (Will be removed in v0.11)",name:"columns",required:!1,type:{name:"enum",value:[{value:'"2col"'},{value:'"3col"'}]}},layout:{defaultValue:null,description:"@deprecated (Will be removed in v0.11)",name:"layout",required:!1,type:{name:"enum",value:[{value:'"slim"'}]}}}}}catch{}const C=e=>a.jsx(T,{...e,bem:"RadioButton",type:"radio",innerWrap:!0}),m=e=>(e.layout&&console.warn("`RadioButtonsGroupProps.layout` is deprecated."),e.columns&&console.warn("`RadioButtonsGroupProps.columns` is deprecated."),a.jsx(k,{...e,bem:"RadioButtonsGroup",modifier:e.stacked&&"stacked",Toggler:C,isRadio:!0}));try{m.displayName="RadioButtonsGroup",m.__docgenInfo={description:"",displayName:"RadioButtonsGroup",props:{className:{defaultValue:null,description:'Container className - alongside "FormField"',name:"className",required:!1,type:{name:"string"}},wrapperProps:{defaultValue:null,description:`Custom HTML attributes for the component's wrapper element.
...
//# sourceMappingURL=CheckboxAndRadioButtons.stories-17c5b8cd.js.map
